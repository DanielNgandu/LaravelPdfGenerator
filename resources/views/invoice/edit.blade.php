                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('store.invoice')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row" id ="client_name">
                                ...
                                <div class="col-12">
                                    <input id="client_name" type="text" class="form-control @error('client_name') is-invalid @enderror" name="client_name" value="{{$companydets_array->company_name}}" required autocomplete="client_name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input id="client_physical_address" type="text" class="form-control @error('client_physical_address') is-invalid @enderror" name="client_physical_address" value="{{$companydets_array->company_physical_address}}" required autocomplete="client_physical_address" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input id="client_postal_address" type="text" class="form-control @error('client_postal_address') is-invalid @enderror" name="client_postal_address" value="{{$companydets_array->company_postal_address}}" required autocomplete="client_physical_address" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input id="client_phone" type="text" class="form-control @error('client_phone') is-invalid @enderror" name="client_phone" value="{{$invoice_array->client_phone}}" required autocomplete="client_phone" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input id="client_email" type="text" class="form-control @error('client_email') is-invalid @enderror" name="client_email" value="{{$invoice_array->client_email}}" required autocomplete="client_email" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input id="validity_period" type="date" class="form-control @error('validity_period') is-invalid @enderror" name="validity_period" placeholder="{{date('d-M-y', strtotime($invoice_array->validity_period))}}" value="{{date('d-M-y', strtotime($invoice_array->validity_period))}}" required autocomplete="validity_period"  autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control" name="description" id="description" rows="3" placeholder="Invoice General Description" value="{{$invoice_array->description}}"></textarea>
